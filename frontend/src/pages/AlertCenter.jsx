  ...
  return (
    <div className="page-wrapper">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <button onClick={loadAlerts} className="secondary-btn" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <h3 style={{ fontSize: '1.15rem', fontWeight: '800', color: '#F8FAFC', marginBottom: '0.35rem' }}>
                      {alert.alert_title}
                    </h3>
                    ...
                    <div style={{ fontSize: '0.75rem', color: '#94A3B8' }}>
                      Location: <strong style={{ color: '#F1F5F9' }}>{alert.location || 'Operational Site'}</strong> ? Hazard: <strong style={{ color: '#F1F5F9' }}>{alert.hazard_category}</strong>
                    </div>
                  </div>

                  <div>
                    {alert.is_acknowledged ? (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#10B981', fontSize: '0.8rem', fontWeight: '700', padding: '0.5rem 0.75rem', background: 'rgba(16, 185, 129, 0.1)', borderRadius: '6px' }}>
                      ...
                      <button
                        ...
                        style={{ background: '#EF4444', borderColor: '#EF4444', fontSize: '0.825rem', padding: '0.6rem 1rem' }}
                      >
